...
public class FarmlandBase extends BlockFarmland implements IModularThing {
	...
	private boolean hasWater(World worldIn, BlockPos pos) {
		for (BlockPos.MutableBlockPos blockpos$mutableblockpos : BlockPos.getAllInBoxMutable(pos.add(-4, -1, -4),
				pos.add(4, 1, 4))) {
	...
	public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance) {
		if (!worldIn.isRemote && 2.0 < fallDistance && entityIn instanceof EntityLivingBase
