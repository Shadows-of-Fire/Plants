...
public class Config {
	...
	public static void syncConfig() { // Gets called from preInit
	    try {
	        Property PDebug = CommonProxy.config.get(Configuration.CATEGORY_GENERAL,
	                "Debug",
	                "false",
	                "Enable Debug Prints",
	                Property.Type.BOOLEAN);
	        
	        Property PBotania = CommonProxy.config.get(Configuration.CATEGORY_GENERAL,
	                "Botania",
	                "true",
	                "Enable the Botania (addon) module.",
	                Property.Type.BOOLEAN);
	        
	        Property PCosmetic = CommonProxy.config.get(Configuration.CATEGORY_GENERAL,
	                "Cosmetic",
	                "true",
	        ...
	        Property PDisableVanilla = CommonProxy.config.get(Configuration.CATEGORY_GENERAL,
	                "DisableVanilla",
	                "false",
	                "(NYI) Disable vanilla flower generation.",
	                Property.Type.BOOLEAN);
	        
	        Property PVineFruit = CommonProxy.config.get(Configuration.CATEGORY_GENERAL,
	                "VineFruit",
	                "5",
	                "A (1/n) chance for vines to drop fruit when broken.",
	        		Property.Type.INTEGER);
	        
	        Property PPatchChance = CommonProxy.config.get("Generator Options",
	                "Chance",
	                "16",
	                "A (1/n) chance for plants to try to generate on a given occasion. Lower = More plants.",
	        		Property.Type.INTEGER);
	        
	        Property PDensity = CommonProxy.config.get("Generator Options",
	                "Density",
	                "32",
	                "The number of plants that try to generate on a given occasion. Higher = More plants.",
	        		Property.Type.INTEGER);
	        
	        Property PPatchSize = CommonProxy.config.get("Generator Options",
	                "Size",
	                "2",
	                "The spread of plants in a given generation attempt. Higher = More plant spread.",
	        		Property.Type.INTEGER);
	        
	        Property PQuantity = CommonProxy.config.get("Generator Options",
	                "Quantity",
	                "3",
	                "The number of plants per generation attempt. Higher = More plants. Use sparingly.",
	        		Property.Type.INTEGER);
	        
	        Property PTries = CommonProxy.config.get("Generator Options",
	                "Tries",
	                "1",
	                "The number of times we decorate per decoration event. Do not make this very big.",
	        		Property.Type.INTEGER);
	        
	        Property PFlowerForests = CommonProxy.config.get("Generator Options",
	                "FlowerForests",
	                "true",
