...
public class AdvancementHelper {
	...
	public static DisplayInfo createDisplay(String langKey, String descKey, ItemStack stack, String background, FrameType type, boolean toast, boolean announce, boolean hidden) {
		return new DisplayInfo(stack, new TextComponentTranslation("advancements." + MODID + "." + langKey), new TextComponentTranslation("advancements." + MODID + "." + descKey), background == null || background.isEmpty() ? null : new ResourceLocation(background), type, toast, announce, hidden);
	}
	...
	public static class AdvancementBuilderBuilder {
		...
		public AdvancementBuilderBuilder(String name) {
