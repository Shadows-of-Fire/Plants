...
public class WorldGenCrystals extends WorldGenFlowers {
	...
	public boolean generate(World world, Random rand, BlockPos position) {
		...
		if (world.isAirBlock(blockpos) && world.getBlockState(blockpos.down()).isSideSolid(world, blockpos.down(), EnumFacing.DOWN))
			world.setBlockState(blockpos, rand.nextFloat() > 0.8F ? dark_shard : shard, 2);
